	...
	return (
		<nav className="navbar navbar-light text-white">
			<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
				https://img.icons8.com/?size=100&id=21576&format=png&color=000000
			...
			<div class="dropdown">
				<button onClick={() => setIsOpen(!isOpen)} class="btn btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
					Dropdown button
				</button>
				{isOpen && (
